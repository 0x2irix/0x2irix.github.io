...
export const siteConfig: SiteConfig = {
	...
	favicon: [
		...
		// {
		//   src: '/assets/images/irix.jpeg',    // Path of the favicon, relative to the /public directory
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/irix.jpeg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	name: "Ahmed Farag",
	bio: "Just a man seeking to be better.",
	links: [
    {
      name: "LinkedIn",
		...
		},
    {
      ...
      url: "https://discord.com/users/yourid",
    },
		{
			...
			url: "https://0x2irix.gitbook.io/0x2irixi",
		},
    {
      name: "HTB",
